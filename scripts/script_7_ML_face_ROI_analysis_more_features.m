...
data_table_var_names = [ROI_names',strcat(ROI_names','_size'),strcat(ROI_names','_std'),{'sub','prop','prop_bin'}];
    ...
    for sub_i = 1:numel(Subjects)
        ...
        for ROI_i = 1:num_of_ROI
            ...
            if ~isempty(clsuter_ind)
                ...
                data_table(sub_i,data_table_var_names{ROI_i+num_of_ROI})={results_table.ROI_size(clsuter_ind)};
                data_table(sub_i,data_table_var_names{ROI_i+num_of_ROI*2})={results_table.std(clsuter_ind)};
