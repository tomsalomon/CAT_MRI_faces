...
if subj_id_num<10
    subj_id_str=['00',num2str(subj_id_num)];
elseif subj_id_num<100
    subj_id_str=['0',num2str(subj_id_num)];
elseif subj_id_num>=100
    subj_id_str=num2str(subj_id_num);
end


logs=dir([outpath,'sub-*',subj_id_str,'_probe_block*.txt']) ;
subject_data=[];
